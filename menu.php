<header id="menu_oficial">
    <div class="container">
        <nav class="navbar navbar-expand-lg">
            <a class="navbar-brand" href="index.php">
                <img id="logotipo" src="./images/logoAssegura-250px.png" alt="Logotipo">
            </a>
...
<a id="botao_flutuante" href="ajude.php">Ajude! </br><i class="fas fa-mouse"></i></a>